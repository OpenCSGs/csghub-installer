...
INSERT INTO public.runtime_frameworks (id, frame_name, frame_version, frame_image, frame_cpu_image, enabled, container_port, type)
    ...
    (20, 'SGLang', 'v0.4.1.post3', 'sglang:v0.4.1.post3-cu124-srt', '', 1, 8000, 1)
ON CONFLICT (id)
    DO UPDATE SET
...
INSERT INTO public.runtime_architectures (id, runtime_framework_id, architecture_name)
    ...
    (138, 20, 'InternLM2ForRewardModel'),
    (139, 20, 'LlamaForClassification'),
    (140, 20, 'DbrxForCausalLM'),
    (141, 20, 'Qwen2VLForConditionalGeneration'),
    (142, 20, 'MistralForCausalLM'),
    (143, 20, 'Olmo2ForCausalLM'),
    (144, 20, 'GPT2LMHeadModel'),
    (145, 20, 'LlavaVidForCausalLM'),
    (146, 20, 'OlmoeForCausalLM'),
    (147, 20, 'ChatGLMModel'),
    (148, 20, 'Grok1ForCausalLM'),
    (149, 20, 'Grok1ModelForCausalLM'),
    (150, 20, 'InternLM2ForCausalLM'),
    (151, 20, 'Phi3SmallForCausalLM'),
    (152, 20, 'StableLmForCausalLM'),
    (153, 20, 'MiniCPMForCausalLM'),
    (154, 20, 'LlavaLlamaForCausalLM'),
    (155, 20, 'LlavaQwenForCausalLM'),
    (156, 20, 'LlavaMistralForCausalLM'),
    (157, 20, 'MllamaForConditionalGeneration'),
    (158, 20, 'LlamaForCausalLM'),
    (159, 20, 'Phi3ForCausalLM'),
    (160, 20, 'Gemma2ForCausalLM'),
    (161, 20, 'XverseForCausalLM'),
    (162, 20, 'QWenLMHeadModel'),
    (163, 20, 'DeepseekForCausalLM'),
    (164, 20, 'MiniCPM3ForCausalLM'),
    (165, 20, 'XverseMoeForCausalLM'),
    (166, 20, 'BaichuanForCausalLM'),
    (167, 20, 'TorchNativeLlamaForCausalLM'),
    (168, 20, 'TorchNativePhi3ForCausalLM'),
    (169, 20, 'QuantMixtralForCausalLM'),
    (170, 20, 'Gemma2ForSequenceClassification'),
    (171, 20, 'GemmaForCausalLM'),
    (172, 20, 'GPTBigCodeForCausalLM'),
    (173, 20, 'CohereForCausalLM'),
    (174, 20, 'ExaoneForCausalLM'),
    (175, 20, 'GraniteForCausalLM'),
    (176, 20, 'LlamaForCausalLMEagle'),
    (177, 20, 'Qwen2ForCausalLM'),
    (178, 20, 'DeepseekV2ForCausalLM'),
    (179, 20, 'DeepseekV3ForCausalLM'),
    (180, 20, 'OlmoForCausalLM'),
    (181, 20, 'MixtralForCausalLM'),
    (182, 20, 'Qwen2MoeForCausalLM'),
    (183, 20, 'YiVLForCausalLM'),
    (184, 20, 'LlamaEmbeddingModel'),
    (185, 20, 'MistralModel')
ON CONFLICT (id)
    DO UPDATE SET
