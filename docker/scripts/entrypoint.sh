...
mkdir -p /var/log/{csghub-server,csghub-accounting,csghub-runner,csghub-user,csghub-rproxy,csghub-portal,csghub-moderation,mirror-lfs,mirror-repo,dnsmasq,temporal,temporal-ui} 2>/dev/null
