...
mkdir -p /var/log/{csghub-server,csghub-accounting,csghub-runner,csghub-user,csghub-proxy,csghub-portal,mirror-lfs,mirror-repo,dnsmasq,temporal,csghub-dataviewer} 2>/dev/null
