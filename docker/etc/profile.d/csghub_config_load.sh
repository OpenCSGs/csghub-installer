...
if [ "$SERVER_PORT" == "80" ]; then
  ...
  export SERVER_ENDPOINT=${SERVER_ENDPOINT:-"https://$SERVER_DOMAIN"}
else
...
export STARHUB_SERVER_GITALY_STORGE="default"
...
export STARHUB_SERVER_S3_REGION=${S3_REGION}
...
export STARHUB_SERVER_SENSITIVE_CHECK_ENABLE=${STARHUB_SERVER_SENSITIVE_CHECK_ENABLE:-false}
export STARHUB_SERVER_SENSITIVE_CHECK_ACCESS_KEY_ID=${SENSITIVE_CHECK_ACCESS_KEY_ID}
export STARHUB_SERVER_SENSITIVE_CHECK_ACCESS_KEY_SECRET=${SENSITIVE_CHECK_ACCESS_KEY_SECRET}
export STARHUB_SERVER_SENSITIVE_CHECK_REGION=${SENSITIVE_CHECK_REGION}